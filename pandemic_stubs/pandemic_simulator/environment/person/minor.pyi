...
class Minor(BasePerson):
    def __init__(self, person_id: PersonID, home: LocationID, school: Optional[LocationID] = ..., school_time: Optional[SimTimeTuple] = ..., regulation_compliance_prob: float = ..., init_state: Optional[PersonState] = ...) -> None: ...
    @property
