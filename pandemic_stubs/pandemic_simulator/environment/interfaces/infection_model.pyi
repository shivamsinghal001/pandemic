...
class IndividualInfectionState:
    ...
    shows_symptoms: bool
    def __init__(self, summary, spread_probability, exposed_rnb, is_hospitalized, shows_symptoms) -> None: ...

class InfectionModel(ABC, metaclass=abc.ABCMeta):
    @abstractmethod
    def step(self, subject_infection_state: Optional[IndividualInfectionState], subject_age: int, subject_risk: Risk, infection_probability: float) -> IndividualInfectionState: ...
    @abstractmethod
