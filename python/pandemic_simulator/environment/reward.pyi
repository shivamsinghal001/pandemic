...
class SumReward(RewardFunction):
    def __init__(self, reward_fns: List[RewardFunction], weights: Optional[List[float]] = ..., *args: Any, **kwargs: Any) -> None: ...
    def calculate_reward(self, prev_obs: PandemicObservation, action: int, obs: PandemicObservation) -> float: ...

class InfectionSummaryIncreaseReward(RewardFunction):
    def __init__(self, summary_type: InfectionSummary, *args: Any, **kwargs: Any) -> None: ...
    def calculate_reward(self, prev_obs: PandemicObservation, action: int, obs: PandemicObservation) -> float: ...
...
class UnlockedBusinessLocationsReward(RewardFunction):
    def __init__(self, obs_indices: Optional[Sequence[int]] = ..., *args: Any, **kwargs: Any) -> None: ...
    def calculate_reward(self, prev_obs: PandemicObservation, action: int, obs: PandemicObservation) -> float: ...
