...
class PandemicGymEnv(gym.Env):
	...
	def step(self, action: int) -> Tuple[PandemicObservation, float, bool, Dict]:
		...
		return self._obs_with_history, self._last_reward, done, {"rew": self._last_reward, "true_rew": self._last_true_reward, "rew_breakdown": last_rew_breakdown, "true_rew_breakdown": last_true_rew_breakdown}
