from ..interfaces import ContactTracer, LocationID, NoOP, PandemicRegulation, Person, PersonID, PersonState, SimTime
from typing import Optional, Sequence

class BasePerson(Person):
    def __init__(self, person_id: PersonID, home: LocationID, regulation_compliance_prob: float = ..., init_state: Optional[PersonState] = ...) -> None: ...
